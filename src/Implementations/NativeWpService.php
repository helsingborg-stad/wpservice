 ...
 * @inheritDoc
 */
    public function wpHandleSideload(array $file, array|false $overrides, string|null $time): array
    {
 ...
 * @inheritDoc
 */
    public function networkStep1(false|\WP_Error $errors): void
    {
 ...
 * @inheritDoc
 */
    public function addManagementPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addOptionsPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addThemePage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addPluginsPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addUsersPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addDashboardPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addPostsPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addMediaPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addLinksPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function addPagesPage(string $pageTitle, string $menuTitle, string $capability, string $menuSlug, callable $callback, int $position): string|false
    {
 ...
 * @inheritDoc
 */
    public function wpCategoryChecklist(int $postId, int $descendantsAndSelf, array|false $selectedCats, array|false $popularCats, \Walker $walker, bool $checkedOntop): void
    {
 ...
 * @inheritDoc
 */
    public function parentDropdown(int $defaultPage, int $parentPage, int $level, int|\WP_Post $post): false
    {
 ...
 * @inheritDoc
 */
    public function addMetaBox(string $id, string $title, callable $callback, string|array|\WP_Screen $screen, string $context, string $priority, array $callbackArgs): void
    {
 ...
 * @inheritDoc
 */
    public function wpDeleteUser(int $id, int $reassign): bool
    {
 ...
 * @inheritDoc
 */
    public function getBlockThemeFolders(string $themeStylesheet): array
    {
 ...
 * @inheritDoc
 */
    public function getBlockTemplate(string $id, string $templateType): \WP_Block_Template|null
    {
 ...
 * @inheritDoc
 */
    public function hasBlock(string $blockName, int|string|\WP_Post|null $post): bool
    {
 ...
 * @inheritDoc
 */
    public function blockCoreNavigationLinkBuildCssColors(array $context, array $attributes, bool $isSubMenu): array
    {
 ...
 * @inheritDoc
 */
    public function wpCacheDecr(int|string $key, int $offset, string $group): int|false
    {
 ...
 * @inheritDoc
 */
    public function termDescription(int $term, null $deprecated): string
    {
 ...
 * @inheritDoc
 */
    public function sanitizeCategory(object|array $category, string $context): object|array
    {
 ...
 * @inheritDoc
 */
    public function commentClass(string|array $cssClass, int|\WP_Comment $comment, int|\WP_Post $post, bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function getCommentClass(string|array $cssClass, int|\WP_Comment $commentId, int|\WP_Post $post): array
    {
 ...
 * @inheritDoc
 */
    public function commentsNumber(string|false $zero, string|false $one, string|false $more, int|\WP_Post $post): void
    {
 ...
 * @inheritDoc
 */
    public function getCommentsNumberText(string|false $zero, string|false $one, string|false $more, int|\WP_Post $post): string
    {
 ...
 * @inheritDoc
 */
    public function commentType(string|false $commenttxt, string|false $trackbacktxt, string|false $pingbacktxt): void
    {
 ...
 * @inheritDoc
 */
    public function trackbackUrl(bool $deprecatedEcho): string
    {
 ...
 * @inheritDoc
 */
    public function wpListComments(string|array $args, array $comments): string
    {
 ...
 * @inheritDoc
 */
    public function getCommentPagesCount(array $comments, int $perPage, bool $threaded): int
    {
 ...
 * @inheritDoc
 */
    public function getPostEmbedUrl(int|\WP_Post $post): string|false
    {
 ...
 * @inheritDoc
 */
    public function getCommentGuid(int|\WP_Comment $commentId): string|false
    {
 ...
 * @inheritDoc
 */
    public function getDateFromGmt(string $dateString, string $format): string
    {
 ...
 * @inheritDoc
 */
    public function wpTrimExcerpt(string $text, int|object $post): string
    {
 ...
 * @inheritDoc
 */
    public function wpGetHttpHeaders(string $url, bool $deprecated): \WpOrg\Requests\Utility\CaseInsensitiveDictionary|false
    {
 ...
 * @inheritDoc
 */
    public function wpJsonEncode(mixed $value, int $flags, int $depth): string|false
    {
 ...
 * @inheritDoc
 */
    public function wpSendJson(mixed $response, int $statusCode, int $flags): void
    {
 ...
 * @inheritDoc
 */
    public function wpSendJsonSuccess(mixed $value, int $statusCode, int $flags): void
    {
 ...
 * @inheritDoc
 */
    public function wpSendJsonError(mixed $value, int $statusCode, int $flags): void
    {
 ...
 * @inheritDoc
 */
    public function forceSslAdmin(string|bool $force): bool
    {
 ...
 * @inheritDoc
 */
    public function wpSuspendCacheAddition(bool $suspend): bool
    {
 ...
 * @inheritDoc
 */
    public function wpDebugBacktraceSummary(string $ignoreClass, int $skipFrames, bool $pretty): string|array
    {
 ...
 * @inheritDoc
 */
    public function wpPrivacyAnonymizeIp(string $ipAddr, bool $ipv6Fallback): string
    {
 ...
 * @inheritDoc
 */
    public function getHeader(string $name, array $args): false
    {
 ...
 * @inheritDoc
 */
    public function getFooter(string $name, array $args): false
    {
 ...
 * @inheritDoc
 */
    public function getSidebar(string $name, array $args): false
    {
 ...
 * @inheritDoc
 */
    public function singlePostTitle(string $prefix, bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function singleCatTitle(string $prefix, bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function singleMonthTitle(string $prefix, bool $display): string|false
    {
 ...
 * @inheritDoc
 */
    public function theDate(string $format, string $before, string $after, bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function getPostModifiedTime(string $format, bool $gmt, int|\WP_Post $post, bool $translate): string|int|false
    {
 ...
 * @inheritDoc
 */
    public function _ex(string $text, string $context, string $domain): void
    {
 ...
 * @inheritDoc
 */
    public function permalinkAnchor(string $mode): void
    {
 ...
 * @inheritDoc
 */
    public function getThePermalink(int|\WP_Post $post, bool $leavename): string|false
    {
 ...
 * @inheritDoc
 */
    public function getPermalink(int|\WP_Post $post, bool $leavename): string|false
    {
 ...
 * @inheritDoc
 */
    public function getPostPermalink(int|\WP_Post $post, bool $leavename, bool $sample): string|false
    {
 ...
 * @inheritDoc
 */
    public function getEditPostLink(int|\WP_Post $post, string $context): string|null
    {
 ...
 * @inheritDoc
 */
    public function getDeletePostLink(int|\WP_Post $post, string $deprecated, bool $forceDelete): string
    {
 ...
 * @inheritDoc
 */
    public function getEditCommentLink(int|\WP_Comment $commentId): string
    {
 ...
 * @inheritDoc
 */
    public function getEditBookmarkLink(int|\stdClass $link): string
    {
 ...
 * @inheritDoc
 */
    public function nextPosts(int $maxPage, bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function getNextPostsLink(string $label, int $maxPage): string
    {
 ...
 * @inheritDoc
 */
    public function nextPostsLink(string $label, int $maxPage): void
    {
 ...
 * @inheritDoc
 */
    public function previousPosts(bool $display): string
    {
 ...
 * @inheritDoc
 */
    public function getCommentsPagenumLink(int $pagenum, int $maxPage): string
    {
 ...
 * @inheritDoc
 */
    public function getNextCommentsLink(string $label, int $maxPage): string
    {
 ...
 * @inheritDoc
 */
    public function networkHomeUrl(string $path, string|null $scheme): string
    {
 ...
 * @inheritDoc
 */
    public function getDashboardUrl(int $userId, string $path, string $scheme): string
    {
 ...
 * @inheritDoc
 */
    public function getEditProfileUrl(int $userId, string $scheme): string
    {
 ...
 * @inheritDoc
 */
    public function wpGetShortlink(int $id, string $context, bool $allowSlugs): string
    {
 ...
 * @inheritDoc
 */
    public function timerStop(int|bool $display, int $precision): string
    {
 ...
 * @inheritDoc
 */
    public function addImageSize(string $name, int $width, int $height, bool|array $crop): void
    {
 ...
 * @inheritDoc
 */
    public function setPostThumbnailSize(int $width, int $height, bool|array $crop): void
    {
 ...
 * @inheritDoc
 */
    public function wpCalculateImageSizes(string|array $size, string|null $imageSrc, array|null $imageMeta, int $attachmentId): string|false
    {
 ...
 * @inheritDoc
 */
    public function wpFilterContentTags(string $content, string $context): string
    {
 ...
 * @inheritDoc
 */
    public function wpGetimagesize(string $filename, array $imageInfo): array|false
    {
 ...
 * @inheritDoc
 */
    public function switchToBlog(int $newBlogId, bool $deprecated): true
    {
 ...
 * @inheritDoc
 */
    public function getLastUpdated(mixed $deprecated, int $start, int $quantity): array
    {
 ...
 * @inheritDoc
 */
    public function addExistingUserToBlog(array|false $details): true|\WP_Error
    {
 ...
 * @inheritDoc
 */
    public function wpUpdateNetworkCounts(int|null $networkId): void
    {
 ...
 * @inheritDoc
 */
    public function wpMaybeUpdateNetworkSiteCounts(int|null $networkId): void
    {
 ...
 * @inheritDoc
 */
    public function wpMaybeUpdateNetworkUserCounts(int|null $networkId): void
    {
 ...
 * @inheritDoc
 */
    public function wpGetAssociatedNavMenuItems(int $objectId, string $objectType, string $taxonomy): array
    {
 ...
 * @inheritDoc
 */
    public function unregisterSetting(string $optionGroup, string $optionName, callable $deprecated): void
    {
 ...
 * @inheritDoc
 */
    public function hasAction(string $hookName, callable|string|array|false $callback): bool|int
    {
 ...
 * @inheritDoc
 */
    public function getTheContent(string $moreLinkText, bool $stripTeaser, int|object $post): string
    {
 ...
 * @inheritDoc
 */
    public function wpListPostRevisions(int|\WP_Post $post, string $type): void
    {
 ...
 * @inheritDoc
 */
    public function getPostStatus(int|\WP_Post $post): string|false
    {
 ...
 * @inheritDoc
 */
    public function getPostTypes(array|string $args, string $output, string $operator): array
    {
 ...
 * @inheritDoc
 */
    public function wpDeletePost(int $postId, bool $forceDelete): \WP_Post|false|null
    {
 ...
 * @inheritDoc
 */
    public function wpGetPostTerms(int $postId, string|array $taxonomy, array $args): array|\WP_Error
    {
 ...
 * @inheritDoc
 */
    public function wpInsertPost(array $postarr, bool $wpError, bool $fireAfterHooks): int|\WP_Error
    {
 ...
 * @inheritDoc
 */
    public function wpSetPostTerms(int $postId, string|array $terms, string $taxonomy, bool $append): array|false|\WP_Error
    {
 ...
 * @inheritDoc
 */
    public function wpGetAttachmentMetadata(int $attachmentId, bool $unfiltered): array|false
    {
 ...
 * @inheritDoc
 */
    public function wpMimeTypeIcon(string|int $mime, string $preferredExt): string|false
    {
 ...
 * @inheritDoc
 */
    public function updatePostCaches(array $posts, string $postType, bool $updateTermCache, bool $updateMetaCache): void
    {
 ...
 * @inheritDoc
 */
    public function wpRestorePostRevision(int|\WP_Post $revision, array $fields): int|false|null
    {
 ...
 * @inheritDoc
 */
    public function wpGetPostRevisions(int|\WP_Post $post, array|null $args): array
    {
 ...
 * @inheritDoc
 */
    public function wpMaybeUpdateUserCounts(int|null $networkId): bool
    {
